...
<div class="bg-[#F7F3F3] w-full overflow-hidden pointer-events-none z-10 -mb-1" style="line-height: 0;">
	<svg class="w-full h-auto block" viewBox="0 0 1440 140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
		<path d="M0,40 C300,-10 600,120 900,40 C1200,-20 1440,40 1440,40 L1440,140 L0,140 Z" fill="#FF4901"></path>
	</svg>
</div>
...
<!-- Vague orange en bas -->
<div class="w-full overflow-hidden pointer-events-none z-10 wave-inverted -mt-1 mb-10" style="line-height: 0;">
	<svg class="w-full h-auto block" viewBox="0 0 1440 140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
		<path d="M0,40 C300,-10 600,120 900,40 C1200,-20 1440,40 1440,40 L1440,140 L0,140 Z" fill="#FF4901"></path>
	</svg>
</div>
